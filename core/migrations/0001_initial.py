# Generated by Django 5.1.4 on 2025-07-30 13:10
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rating', models.PositiveSmallIntegerField(choices=[(1, 'Ужасно, плохо, нехорошо'), (2, 'Плохо но хотябы жив'), (3, 'Нормально нормально'), (4, 'Хорошо'), (5, 'Супер ультра мега хорошо')], default=5, verbose_name='Оценка')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('not_approved', 'Не подтверждена'), ('new', 'Новая'), ('confirmed', 'Подтверждена'), ('cancelled', 'Отменена'), ('completed', 'Выполнена')], default='not_approved', max_length=50, verbose_name='Статус')),
